...
public class ItemGenerator{
	...
	public static Item generate(){
		...
		poss[1] = new Item(ItemType.Other, "Broom", 3, 4, 0, 3, 15);
		
		poss[2] = new Item(ItemType.Other, "Book", 2, 7, 0, 8, 3);
		
		poss[3] = new Item(ItemType.Other, "Silver Cup", 2, 7, 0, 7, 14);
		...
		poss[6] = new Item(ItemType.Armor, "Iron Armor", 29, 298, 14, 19, 7);
		
		poss[7] = new Item(ItemType.Armor, "Steel Armor", 35, 456, 16, 20, 4);
		...
		poss[17] = new Item(ItemType.Weapon,"Wooden Staff", 19, 160, 17, 14, 16);
		
		poss[18] = new Item(ItemType.Weapon,"Iron Staff", 25, 297, 18, 12, 7);
		
		poss[19] = new Item(ItemType.Weapon,"Steel Staff", 32, 323, 19, 18, 8);
