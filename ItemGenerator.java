/**
 * <tt>ItemGenerator</tt> is a generator that produced a random time from an array of items. These items are placed on the board for the player to add to their inventory and use. Since it is a random generator, there can be multiple items of the same type in the game.
