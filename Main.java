...
public class Main{
	...
	/** This is the main method to play the game. It creates a player, side character, items, monsters, and world. This method is needed to play the game. Here the player is able to tell the program to move up, down, left, or right, print their inventory, add or drop items, fight monsters, restore their health with a health potion, and load/save a game. The items and monsters  created in this class are randomly generated. 
	 * @param args Required for running.
