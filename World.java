...
class World{
	...
	public int fillWorld(Player player, Item item1, Item item2, Item item3, Item item4, Item item5, Item item6, Item item7, Enemy enemy1, Enemy enemy2, Enemy enemy3, Enemy enemy4){ 	

		Scanner in = new Scanner(System.in);
		
		//Set the main room as room1.
		room1.fillRoom(player, item1, item2, item3, item4, item5, item6, item7, enemy1, enemy2, enemy3, enemy4);
		...
		if(currentRoom == 0){
			...
			if(player.getPositionX() == 9 && player.getPositionY() == 28 && currentRoom == 0){
				...
				if(input.equals("Y")){
					...
					player.y = 1;
					System.out.println("You manage to push aside the heavy rocks and push your body through the entrance...");
					room3.fillRoom(player, item1, item2, item3, item4, item5, item6, item7, enemy1, enemy2, enemy3, enemy4);
				}
				else{
					System.out.println("You decide to keep exploring the room you are currently in...");
				}
